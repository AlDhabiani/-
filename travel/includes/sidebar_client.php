...
/**
 * ============================================================
 *  القائمة الجانبية — لوحة العميل (البداية)
...
<div class="dash-topbar d-lg-none">
    ...
    <span class="brand-text fs-5"><?= e(SITE_NAME) ?> <span class="text-gold">| حسابي</span></span>
</div>
    ...
    <aside class="dash-sidebar" id="dashSidebar">
        ...
        <div class="sidebar-user d-flex align-items-center">
            ...
            <div class="ms-2 overflow-hidden">
                ...
                <div class="sidebar-user-role"><i class="fa-solid fa-user me-1 text-gold"></i><?= e(getRoleLabel($user['role'])) ?></div>
            </div>
        </div>

        <nav class="sidebar-nav">
            <a href="dashboard.php" class="nav-link<?= $active === 'dashboard' ? ' active' : '' ?>"><i class="fa-solid fa-gauge-high"></i>لوحة التحكم</a>
            <a href="my_bookings.php" class="nav-link<?= $active === 'bookings' ? ' active' : '' ?>"><i class="fa-solid fa-ticket"></i>حجوزاتي</a>
            <a href="../packages.php" class="nav-link"><i class="fa-solid fa-compass"></i>تصفح الباقات</a>
