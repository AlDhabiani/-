...
/**
 * ============================================================
 *  القائمة الجانبية — لوحة وكيل السياحة (البداية)
...
<div class="dash-topbar d-lg-none">
    ...
    <span class="brand-text fs-5"><?= e(SITE_NAME) ?> <span class="text-gold">| لوحة الوكيل</span></span>
</div>
    ...
    <aside class="dash-sidebar" id="dashSidebar">
        ...
        <div class="sidebar-user d-flex align-items-center">
            ...
            <div class="ms-2 overflow-hidden">
                ...
                <div class="sidebar-user-role"><i class="fa-solid fa-building-user me-1 text-gold"></i><?= e(getRoleLabel($user['role'])) ?></div>
            </div>
        </div>

        <nav class="sidebar-nav">
            <a href="dashboard.php" class="nav-link<?= $active === 'dashboard' ? ' active' : '' ?>"><i class="fa-solid fa-gauge-high"></i>لوحة التحكم</a>
            <a href="my_packages.php" class="nav-link<?= $active === 'packages' ? ' active' : '' ?>"><i class="fa-solid fa-box-open"></i>باقاتي</a>
            <a href="bookings.php" class="nav-link<?= $active === 'bookings' ? ' active' : '' ?>"><i class="fa-solid fa-ticket"></i>حجوزات باقاتي</a>
            <hr class="sidebar-divider">
            <a href="profile.php" class="nav-link<?= $active === 'profile' ? ' active' : '' ?>"><i class="fa-solid fa-user"></i>ملفي الشخصي</a>
            <a href="change_password.php" class="nav-link<?= $active === 'password' ? ' active' : '' ?>"><i class="fa-solid fa-key"></i>تغيير كلمة المرور</a>
            <hr class="sidebar-divider">
